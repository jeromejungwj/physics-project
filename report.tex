...
\textbf{Project Group:} & [e.g., Group 4 / Team Dzhanibekov] \\[1ex]
\textbf{Group Members:} & Student Name 1
(\textit{Derivations \& Mathematical Layout}) \\
& Student Name 2 (\textit{Computational Modeling \& Plots}) \\
& Student Name 3 (\textit{Literature Review \&
Commentary}) \\[1ex]
\textbf{Course Title:}  & General Physics I \\
\textbf{Instructor:}    & Dr. Professor Name \\
\textbf{Department:}    & Department of Physics, University Name
\end{tabular}
}
\date{\today}
\begin{document}
